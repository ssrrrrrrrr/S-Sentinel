...
func TestRuntimeActionExecutionResultRollbackEvidenceStoreAndPortalLatestResource(t *testing.T) {
	root, err := filepath.Abs("..")
	if err != nil {
		t.Fatalf("resolve repo root: %v", err)
	}
  ...
  "rollbackTarget": {
    ...
    "source": "portal_e2e_fixture",
    "commandArgumentMode": "explicit_to_revision",
  ...
  "writeGate": {
    "preflightStatus": "PREFLIGHT_PASSED",
    "eligibilityStatus": "ELIGIBLE_FOR_CONTROLLED_EXECUTOR",
    "operation": "ROLLBACK_ROLLOUT",
    "operationGateEnv": "S_SENTINEL_ALLOW_RUNTIME_ROLLBACK",
    "finalExecuteEnv": "S_SENTINEL_RUNTIME_ROLLBACK_EXECUTE",
    "finalExecuteEnabled": true,
    "writeAllowed": true
  },
  "beforeSnapshot": {
  ...
  "afterSnapshot": {
    ...
    "postActionRolloutGetAttempted": true,
    "postActionRolloutGetSucceeded": true,
    "rolledBackAssumedFromCommandSuccess": true,
    "phase": "Healthy",
    "degraded": false,
    "currentStepIndex": 0,
    "stableRS": "demo-app-stable",
  ...
  "postActionVerification": {
    ...
    "rollbackPhaseObserved": true,
    "rollbackTargetObserved": true,
    "observedStableRS": "demo-app-stable",
  ...
  "guardrails": {
	...
	latestResult := callB4PortalJSON(t, api.handleLatestResource("runtimeActionExecutionResult"), http.MethodGet, "/api/releases/latest/runtime-action-execution-result", http.StatusOK)
	requireB4String(t, latestResult, "runtimeActionExecutionResultId", resultID)
	requireB4NestedString(t, latestResult, "action", "requestedAction", "ROLLBACK_ROLLOUT")
	requireB4NestedString(t, latestResult, "action", "actionStatus", "EXECUTION_SUCCEEDED")
	requireB4NestedString(t, latestResult, "action", "commandMode", "kubectl_argo_rollouts_undo_to_revision")
	requireB4NestedString(t, latestResult, "result", "executionStatus", "SUCCEEDED")
	requireB4NestedString(t, latestResult, "result", "verificationStatus", "VERIFIED")
	requireB4NestedString(t, latestResult, "postActionVerification", "verificationStatus", "VERIFIED")
	requireB4JSONContains(t, latestResult, "rollbackVerified")
	requireB4JSONContains(t, latestResult, "didRollback")
	requireB4JSONContains(t, latestResult, "rollbackTarget")
	...
	requireB4String(t, resultObject, "schemaVersion", "evidence.store.object/v1alpha1")
	requireB4JSONContains(t, resultObject, "runtimeActionExecutionResult")
	requireB4JSONContains(t, resultObject, "ROLLBACK_ROLLOUT")
	requireB4JSONContains(t, resultObject, "EXECUTION_SUCCEEDED")
	requireB4JSONContains(t, resultObject, "kubectl_argo_rollouts_undo_to_revision")
	requireB4JSONContains(t, resultObject, "mutatedKubernetes")
	requireB4JSONContains(t, resultObject, "verificationStatus")
	requireB4JSONContains(t, resultObject, "VERIFIED")
	requireB4JSONContains(t, resultObject, "rollbackVerified")
	requireB4JSONContains(t, resultObject, "didRollback")
	requireB4JSONContains(t, resultObject, "rollbackTarget")
	requireB4JSONContains(t, resultObject, "targetRevision")
	...
	requireB4JSONContains(t, releaseDetail, "runtimeActionExecutionResult")
	requireB4JSONContains(t, releaseDetail, resultID)
	requireB4JSONContains(t, releaseDetail, "ROLLBACK_ROLLOUT")
	requireB4JSONContains(t, releaseDetail, "verificationStatus")
	requireB4JSONContains(t, releaseDetail, "VERIFIED")
	requireB4JSONContains(t, releaseDetail, "rollbackVerified")
	requireB4JSONContains(t, releaseDetail, "didRollback")
