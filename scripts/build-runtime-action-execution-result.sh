...
doc = {
    ...
    "gateSummary": {
        "preflight": "passed" if preflight_passed else "blocked",
        "global": "enabled" if global_gate_enabled else "disabled",
        "operation": "enabled" if operation_gate_enabled else "disabled",
        "approval": "enabled" if approval_gate_enabled else "disabled",
        "finalExecute": "enabled" if final_execute_enabled else "disabled",
