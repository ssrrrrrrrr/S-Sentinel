...
def build_release_intelligence_section() -> str:
...
## 11. Release Intelligence 历史智能摘要
...
release_intelligence_section = build_release_intelligence_section()
safety_section_number = "12" if release_intelligence_section else "11"
