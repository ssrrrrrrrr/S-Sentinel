...
TMP_DIR=".tmp/test-runtime-action-execution-result-promote-final-switch-off"
RELEASE_ID="runtime-action-promote-final-switch-off-smoke"
...
cat > "$TMP_DIR/runtime-action-recommendation-$RELEASE_ID.json" <<JSON
{
  ...
  "generatedBy": "test-runtime-action-execution-result-promote-final-switch-off.sh",
  "generatedAt": "2026-05-27T08:03:03Z",
  ...
  "recommendation": {
    ...
    "reasons": ["manual_promote_final_switch_off_fixture"],
    "summary": "Synthetic fixture for promote rollout final switch off execution-result."
  },
  "runtimeSnapshot": {
...
doc["approval"]["approvedBy"] = "test-runtime-action-execution-result-promote-final-switch-off"
...
assert action["commandMode"] == "kubectl_argo_rollouts_promote", doc
assert action["commandPreviewArgs"] == ["kubectl", "argo", "rollouts", "promote", "demo-app", "-n", "slo-rollout"], doc
...
print("PASS runtime action execution result promote final switch off")
PYASSERT
